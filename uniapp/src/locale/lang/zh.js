...
export default {
  ...
  core: {
    ...
    no_bind_user: '未绑定用户',
    account_has_been_bound: '用户或微信已绑定其它，无法进行绑定',
  ...
  share: {
    ...
    confirm: '确定保存到相册吗',
    nothing: '无',
    titlePainter: '如长时间无法生成，请确认小程序管理后台中是否正确填写域名白名单',
  },
  // 信息修改页
  modify: {
    nametitle: '修改用户名',
  ...
  user: {
    ...
    bindText: '你的微信号未绑定账号，登录/注册可完成绑定',
    ...
    nofounduser: '未找到用户',
    bindconfirmed: '绑定失败，该微信账号已绑定其它账号',
    ...
    registerValidateDes: '{user} ，您好。您已注册，请耐心等待审核',
    validateRejectDes: '{user} ，您好。您的账户未能通过审核 原因：{reason}。',
  },
  // 举报
  report: {
    reportTitle: '举报',
