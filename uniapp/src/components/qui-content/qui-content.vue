    ...
    <view class="themeItem" @click="backgroundClick">
          ...
          <view class="themeItem__header__title__time" v-if="addAsk !== 1">
            ...
            >
              ...
              <!--  <text
                v-if="
                  threadType === 5 &&
                    item.questionTypeAndMoney !== null &&
      ...
      <view class="themeItem__content" @click.stop="" @click="contentClick">
        ...
        >
          ...
          <view
            :class="
              item.isRedPacket === 1 && threadType === 1
          ...
          >
            ...
            >
              <view class="themeItem__content__text__longessay__publish">
                ...
                <!-- 红包logo -->
                <image
                  v-if="item.isRedPacket == 1 && (threadType === 1 || threadType === 0)"
            ...
            <view
              :class="
                threadType !== 0 || item.isRedPacket == 1
                  ? item.isRedPacket != 1 &&
                    (threadType === 0 ||
                      threadType === 1 ||
                      threadType === 2 ||
            ...
            >
              ...
              <image
                v-if="
                  threadType === 5 &&
                    item.questionTypeAndMoney !== null &&
                    item.questionTypeAndMoney.type === 1
                "
                class="themeItem__content__text__longessay__publish__icon"
                src="./../../static/h5-play/QandA@2x.png"
              ></image>
              <image
                v-if="threadType === 5 && item.questionTypeAndMoney === null"
                class="themeItem__content__text__longessay__publish__icon"
                src="./../../static/h5-play/QandA@2x.png"
              ></image>
              <image
                v-if="item.isRedPacket == 1 && threadType !== 1"
                class="themeItem__content__text__longessay__publish__icon"
                src="./../../static/h5-play/redenvelope@2x.png"
              ></image>
              <view
...
export default {
  ...
  mounted() {
    ...
    // #ifdef H5-PLAY || MP-WEIXIN-PLAY
    if (this.item.questionTypeAndMoney) {
      this.rewardAmount = this.item.questionTypeAndMoney.money; // 悬赏金额
    }
