  ...
  <div>
    ...
    >
      ...
      <div class="title">
        <div class="title-info">
          ...
          <div class="time">{{ formatDate(comment.updatedAt) }}</div>
        </div>
        <div class="management" @click.stop="() => {}">
          <div v-if="comment.isShowReport" class="report" @click="toShield(comment._jv.id)">
          ...
          >
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item
                ...
                :divided="true"
                :command="beforeHandleCommand('deleteComment', comment._jv.id)"
              >
                {{ $t("topic.delete") }}
              </el-dropdown-item>
            </el-dropdown-menu>
      ...
      >
        ...
        >
              ...
              <div class="management" @click.stop="() => {}">
                ...
                >
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item
                      v-if="reply.canEdit"
                      :command="beforeHandleReply('editComment', reply, comment._jv.id)"
                    >
                      {{ $t("topic.edit") }}
                    </el-dropdown-item>
                    <el-dropdown-item
                      v-if="reply.canHide"
                      :divided="true"
                      :command="beforeHandleReply('deleteReply', reply._jv.id, comment._jv.id)"
                    >
                      {{ $t("topic.delete") }}
                    </el-dropdown-item>
                  </el-dropdown-menu>
          ...
          <div @click.stop="() => {}">
            <editor
              v-if="threeShowReplyEditorForIndex === replyIndex"
              style="margin-top: 0; margin-bottom: 20px"
              editor-style="reply"
              class="reply-editor"
              selector="reply-editor"
              ...
              :post.sync="replyPost"
              :on-publish="onReplyPublish"
              @publish="replyPublish(reply._jv.id, comment._jv.id)"
            />
          </div>
          <div class="line" />
        </div>
    ...
    <div v-show="showAdoptionBox" class="adoption-box">
      <div class="adoption-content">
        <div class="adoption-head">采纳回复悬赏</div>
        <div class="percent">
        ...
        <div class="btn">
          <el-button round @click="confirmAdoption">确定</el-button>
...
export default {
  ...
  methods: {
    openAdoption(comment) {
      ...
      this.currentCommentId = comment._jv.id;
    ...
    toReply(user, index, reply) {
      ...
      if (reply) {
        ...
        this.commentUserId = user._jv.id;
        console.log(user._jv.id, reply._jv.id);
      } else {
    ...
    commentManagement(command) {
      console.log(command, 'commentManagement');
