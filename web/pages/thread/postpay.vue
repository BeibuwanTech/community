...
export default {
  ...
  data() {
    return {
      ...
      rewardOrRed: '', // redpacket 红包, offerReward 悬赏, reward 指定人问答付费
  ...
  methods: {
    ...
    async publish() {
      ...
      */
      ...
      const create_thread_with_captcha = this.forums && this.forums.qcloud && this.forums.qcloud.qcloud_captcha;
      if (
        !this.isEditor
      ...
      if (create_thread_with_captcha && qcloud_captcha) {
